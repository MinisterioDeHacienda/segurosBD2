...
-- PostgreSQL utiliza una sintasis similar a MySQL se debe tener en cuenta lo sigiuiente: 
-- Usar comillas dobles (") alrededor de los nombres de columnas y valores en mayúsculas, ya que PostgreSQL es sensible a mayúsculas y minúsculas para los identificadores.
-- Eliminar los acentos graves alrededor de los nombres de las columnas, ya que PostgreSQL no requiere que los nombres de las columnas estén entre acentos graves.
